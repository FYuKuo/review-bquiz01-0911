...
<div style="width:99%; height:87%; margin:auto; overflow:auto; border:#666 1px solid;">
    ...
    <form method="post" action="./api/edit.php">
        <table width="100%" class="ct">
            <tbody>
                <tr class="yel">
                    <td width="33%"><?=$STR->t[0]?></td>
                    <td width="33%"><?=$STR->t[1]?></td>
                    <td width="7%"><?=$STR->t[2]?></td>
                    <td width="7%">顯示</td>
                    <td width="7%">刪除</td>
                    <td></td>
                </tr>
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <input type="button" onclick="op('#cover','#cvr','./modal/add_child.php?do=<?=$do?>&id=<?=$row['id']?>')" value="<?=$STR->uB?>">
                    </td>
